...
namespace GCBF_QP
{
    ...
    struct ConstraintInfo {
        double h_value;
        std::vector<std::pair<int, PartStateType>> gradients;
        int obstacle_index = -1;  // 仅对障碍物约束有效
    };
    ...
    private:
        ...
        std::vector<ConstraintInfo> _all_constraints;
        ...
        // 新增：获取单个无人机的所有约束（障碍物 + 其他无人机）
        void get_all_constraints_for_drone(int drone_id);
