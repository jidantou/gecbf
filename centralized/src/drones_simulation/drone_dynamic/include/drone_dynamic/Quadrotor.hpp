...
public:
  ...
  // Control force (world frame) for double-integrator dynamics.
  const Eigen::Vector3d& getControlForce(void) const;
  void setControlForce(const Eigen::Vector3d& force);
